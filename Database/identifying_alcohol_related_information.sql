...
--
-- Host: localhost
-- Generation Time: Oct 05, 2023 at 12:02 PM
...
--
-- Database: `identifying_alcohol_related_information`
--
CREATE DATABASE IF NOT EXISTS `identifying_alcohol_related_information` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `identifying_alcohol_related_information`;
...
('gagxi6xtopwzecmdyqetz0l1ozvn8hfe', 'eyJ1c2VyaWQiOjN9:1qiweI:Ry-3xI-3hoq2bPhWZuU7yEwfC5HEft6VtgXwv4REXKA', '2023-10-04 12:49:46.108199'),
...
('kt0e2jzkvf6r987iic7ymzxvjucesubp', 'eyJ1c2VyaWQiOjF9:1qivKm:jZLfO2amV_NGkAs5AoOkGiWgmcvdF1gBHrC_zGlkGnw', '2023-10-04 11:25:32.612418'),
...
(2, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karantaka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(3, 'tmksmanju', 'tmksmanju19@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karantaka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(25, 'Random Forest Classifier', '51.66340508806262'),
(26, 'SVM', '52.348336594911935'),
(27, 'Logistic Regression', '52.935420743639924'),
(28, 'Decision Tree Classifier', '51.46771037181996');
...
(13, 'No Alcohol Drinking Found', '60.0'),
(14, 'Alcohol Drinking Found', '40.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_identify_alcohol_information`
--

CREATE TABLE IF NOT EXISTS `remote_user_identify_alcohol_information` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `pid` varchar(3000) NOT NULL,
  `gender` varchar(3000) NOT NULL,
  `age` varchar(3000) NOT NULL,
  `hypertension` varchar(3000) NOT NULL,
  `heart_disease` varchar(3000) NOT NULL,
  `clinical_note` varchar(3000) NOT NULL,
  `ever_married` varchar(3000) NOT NULL,
  `work_type` varchar(3000) NOT NULL,
  `Residence_type` varchar(3000) NOT NULL,
  `avg_glucose_level` varchar(3000) NOT NULL,
  `bmi` varchar(3000) NOT NULL,
  `smoking_status` varchar(3000) NOT NULL,
  `stroke` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_identify_alcohol_information`
--

INSERT INTO `remote_user_identify_alcohol_information` (`id`, `Fid`, `pid`, `gender`, `age`, `hypertension`, `heart_disease`, `clinical_note`, `ever_married`, `work_type`, `Residence_type`, `avg_glucose_level`, `bmi`, `smoking_status`, `stroke`, `Prediction`) VALUES
(1, '172.217.10.142-10.42.0.42-443-49015-6', '1665', 'Female', '79', '1', '0', 'Not Found  alcohol drinking ', 'Yes', 'Self-employed', 'Rural', '174.12', '24', 'never smoked', '1', 'No Alcohol Drinking Found'),
(2, '172.217.10.67-10.42.0.42-443-56264-6', '56112', 'Male', '64', '0', '1', 'Found occasinally alcohol drinking ', 'Yes', 'Private', 'Urban', '191.61', '37.5', 'smokes', '1', 'Alcohol Drinking Found'),
(3, '10.42.0.211-23.23.129.231-36010-443-6', '68794', 'Female', '79', '0', '0', 'Not Found  alcohol drinking ', 'Yes', 'Self-employed', 'Urban', '228.7', '26.6', 'never smoked', '1', 'No Alcohol Drinking Found'),
(5, '10.42.0.211-123.125.29.220-52277-80-6', '16590', 'Male', '71', '0', '1', 'Found occasinally alcohol drinking ', 'Yes', 'Private', 'Urban', '81.76', 'N/A', 'smokes', '1', 'Alcohol Drinking Found'),
(6, '10.42.0.151-10.42.0.1-45593-53-17', '47175', 'Female', '49', '0', '0', 'Not Found  alcohol drinking ', 'Yes', 'Private', 'Rural', '129.54', '60.9', 'smokes', '0', 'No Alcohol Drinking Found');
