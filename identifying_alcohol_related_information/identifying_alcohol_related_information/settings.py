...
ROOT_URLCONF = 'identifying_alcohol_related_information.urls'
...
WSGI_APPLICATION = 'identifying_alcohol_related_information.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'identifying_alcohol_related_information',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
